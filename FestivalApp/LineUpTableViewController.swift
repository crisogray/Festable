...
class LineUpTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.setArtist(event.lineUp![indexPath.row])
        return cell
    }

    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        if event.lineUp != nil {
            let artist = event.lineUp![indexPath.row]
            let destViewController = self.storyboard!.instantiateViewControllerWithIdentifier("ArtistInfo") as! ArtistInfoViewController
